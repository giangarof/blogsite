...
//user
import RestorePassword from "./screen/User/RestorePassword.jsx";
import RestorePasswordUpdate from "./screen/User/RestorePasswordUpdate.jsx";
...
const router = createBrowserRouter(
	createRoutesFromElements(
		<Route path="/" element={<App />}>
			...
			{/* Restore password */}
			<Route path="/recover" element={<RestorePassword />} />
			<Route path="/recover/:token" element={<RestorePasswordUpdate />} />
			...
			{/* All routes, if a route is not found */}
